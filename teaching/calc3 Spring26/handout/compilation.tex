...
\begin{prob}
    ...
    \begin{enumerate}
        ...
        \item Can you find a vector that is orthogonal to both of $u,v$? 
        \item Can you find vectors that are orthogonal to any basis of $\R^2$? 
    \end{enumerate}
\end{prob}
...
\begin{prob}
    Construct a $3\times 3$ matrix $A$ such that $\det(A)=0$.
\end{prob}
