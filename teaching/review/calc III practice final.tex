...
\begin{enumerate}[label=\arabic*.]
    ...
    \end{prob}%
    \begin{solution}%
        Set $D=[0,\pi/2]\times[0,2]$. We parameterize $S$ by $\Phi\colon D\to\mathbb R^3$ by $\Phi(\theta,v)=(\cos\theta,\sin\theta,v)$. Then $\Phi_u=(-\sin\theta,\cos\theta,0)$ and $\Phi_v=(0,0,1)$, so the normal is given by
        \[\Phi_u\times\Phi_v=\det\begin{bmatrix}
            i & j & k \\
            -\sin\theta & \cos\theta & 0 \\
            0 & 0 & 1
