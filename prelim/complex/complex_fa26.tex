...
\begin{prop}[Open mapping theorem]
    If $\Omega\subset\C$ is open and connected and $f:\Omega\to\C$ is a nonconstant holomorphic function, then $f$ maps open sets to open sets.
\end{prop}
