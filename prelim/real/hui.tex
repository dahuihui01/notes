...
\declaretheorem[style=huipinkbox,name=Theorem]{thm}
...
\declaretheorem[style=huipurplebox,name=Proposition]{prop}
...
\declaretheorem[style=huiblueblox,name=Example]{example}

\definecolor{nirdarkgreen}{HTML}{537a57}
\definecolor{nirlightgreen}{HTML}{e9f7ea}
...
\declaretheorem[style=nirgreenbox,name=Definition]{defn}
...
% 	headfont=\normalfont\bfseries\color{huidarkblue}
% ]{huiblueblox}
\declaretheorem[style=huiblueblox,name=Problem]{prob}
...
% 	headfont=\normalfont\bfseries\color{huidarkblue}
% ]{huiblueblox}
\declaretheorem[style=huiblueblox,name=Exercise]{exer}
\declaretheorem[style=huipinkbox, name=Corollary]{cor}
