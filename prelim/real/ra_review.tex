...
\end{prop}
\begin{prop}
    Every open set in $\R^1$ can be written as a countable union of disjoint open intervals. Moreover, every open set in $\R^n$ can be written as a countable union of nonoverlapping closed cubes. 
\end{prop}
...
\begin{thm}[Mean-Value Theorem]
    ...
    \begin{equation*}
        \int_a^bfd\phi=f(\xi)[\phi(b)-\phi(a)]
    \end{equation*}
\end{thm}
